...
// ----------------------------------------------------------------------------------------------------------//
        switch (userList[userIndex].status) {
            case "Boas Vindas":
                ...
                if ( hour>5 & hour<12) {
                    emfB.SendMessage(message.from, "Bom dia, eu sou o Max 😀. Estou aqui para te ajudar!")   
                } else if(hour>12 & hour<18) {
                    emfB.SendMessage(message.from, "Boa tarde, eu sou o Max 😀. Estou aqui para te ajudar!")
                } else if(hour>18 & hour<5) {
                    emfB.SendMessage(message.from, "Boa noite, eu sou o Max 😀. Estou aqui para te ajudar!")
                }
